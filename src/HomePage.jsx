              ...
              <div className="feedback-form-container">
                {!submitted ? (
                  <form className="feedback-form" onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginTop: '1rem', padding: '0.5rem', background: '#f0f0f0', fontSize: '0.8rem', borderRadius: '4px' }}>
                      <strong>Debug Info:</strong><br />
                      Faculty: {facultyName || 'Not entered'}<br />
                      Course: {selectedCourse || 'Not selected'}<br />
                      Rating: {rating || 'Not selected'}<br />
                      Comments: {comments ? 'Entered' : 'Empty'}
                    </div>
                  </form>
                ) : (
